...
export const platforms = [
  ...
  },
  {
    "name": "Instagram",
    "svg": (
      <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" opacity="0.5">
  ...
  },
  {
    "name": "TikTok",
    "svg": (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" opacity="0.5">
  ...
  },
  {
    "name": "X / Twitter",
    "svg": (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" opacity="0.5">
...
export const painPoints = [
  {
    ...
    description: "Spending hours scrolling through platforms trying to decode what's trending right now — while trends expire by the hour.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Manually clipping, resizing, captioning, and reformatting for every platform burns hours that could go to creating.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Posting and praying isn't a strategy. Without data-driven insights, content growth is unpredictable and frustrating.",
  },
];
...
export const features = [
  {
    ...
    description: "Automatically extracts high-engagement moments from long videos and formats them for maximum impact.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Recommends content ideas based on real-time viral patterns across platforms.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Acts autonomously to optimize your content strategy — no manual intervention needed.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Advanced dashboards showing engagement, retention, and growth metrics in real time.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Detects powerful openings that increase watch time and keep viewers hooked from the first second.",
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Formats clips automatically for Reels, Shorts, TikTok, and more — all in one click.",
  },
];
...
export const steps = [
  {
    ...
    description: "Drop any long-form video — podcast, vlog, stream, or tutorial. Memora AI handles the rest.",
    icon: (
  ...
  },
  {
    ...
    description: "Our agentic AI analyzes hooks, engagement patterns, and trend data to find the clips most likely to go viral.",
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Export optimized clips for every platform and monitor performance with real-time analytics dashboards.",
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const testimonials = [
  {
    ...
    avatar: "SC",
    color: "#4f46e5",
    quote: "Memora AI literally changed the game for my Shorts strategy. I went from 50K to 500K views per Short in under two months. The viral detection is scary accurate.",
  },
  {
    name: "Marcus Rivera",
    handle: "@marcusriv",
    ...
    avatar: "MR",
    color: "#7c3aed",
    quote: "I used to spend 4 hours editing clips. Now Memora pulls the best moments automatically. My engagement rate jumped 3x and I actually have time to create more content.",
  },
  {
    name: "Priya Sharma",
    handle: "@priyatalks",
    ...
    avatar: "PS",
    color: "#06b6d4",
    quote: "The trend intelligence feature is what sets Memora apart. It tells me exactly what topics are surging — so I'm always creating content that people are actively searching for.",
  },
];
