...
const HeroSection = () => {
  return (
    ...
    >
      <div className="absolute top-20 left-10 w-125 h-125 rounded-full opacity-30 animate-pulseGlow pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(79,70,229,0.2), transparent 70%)" }} />
      <div className="absolute bottom-20 right-10 w-100 h-100 rounded-full opacity-20 animate-pulseGlow pointer-events-none"
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
        <div className="flex flex-col gap-6 animate-fadeInUp">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface border border-border w-fit text-sm font-medium text-muted">
