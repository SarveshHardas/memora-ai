    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            onClick={toggleTheme}
            className="relative w-10 h-10 rounded-xl flex items-center justify-center bg-surface border border-border hover:border-primary transition-all duration-200 cursor-pointer"
        ...
        <div className="flex md:hidden items-center gap-3">
          <button
            onClick={toggleTheme}
            className="w-9 h-9 rounded-lg flex items-center justify-center bg-surface border border-border cursor-pointer"
            aria-label="Toggle theme"
          >
            {theme === "light" ? (
              <svg
      ...
      >
        <div className="px-6 pt-4 pb-6 flex flex-col gap-4 glass mt-2 mx-4 rounded-2xl">
          ...
          <a
            href="#pricing"
            className="btn-primary text-sm text-center py-2.5! mt-2"
          >
            Start Creating
          </a>
        </div>
