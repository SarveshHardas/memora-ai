    ...
    return (
        ...
        >
            ...
            <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-6 md:pt-10 pb-16">
                ...
                {/* Tab bar */}
                <div className="animate-fadeInUp flex gap-2 p-1.5 rounded-2xl bg-[var(--surface)] border border-[var(--border-color)] shadow-sm mb-8 max-w-md mx-auto"
                ...
                >
                    <button
                        ...
                        style={activeTab === "thumbnail" ? { background: "var(--gradient-primary)" } : {}}
                    >
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button
                        ...
                        style={activeTab === "caption" ? { background: "var(--gradient-primary)" } : {}}
                    >
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="card !rounded-2xl !p-6 hover:!transform-none">
                                <label className="block text-sm font-semibold mb-3 text-[var(--foreground)]">
                                    <span className="flex items-center gap-2">
                                        ...
                                        Reference Images
                                        <span className="text-xs font-normal text-[var(--muted)]">(optional, max 4)</span>
                                    </span>
                                </label>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center gap-3">
                                        <div
                                            ...
                                            style={{ background: isDragOver ? "var(--gradient-primary)" : "var(--surface-hover)" }}
                                        >
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={isDragOver ? "white" : "var(--muted)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-[var(--foreground)]">
                                                Drop images here or <span className="text-[var(--primary)]">browse</span>
                                            </p>
                                ...
                                {imagePreviews.length > 0 && (
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                                        {imagePreviews.map((preview, index) => (
                                            <div key={index} className="relative group rounded-xl overflow-hidden aspect-square border border-[var(--border-color)]">
                                                <img
                                                    src={preview}
                                                    alt={`Upload ${index + 1}`}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="card !rounded-2xl !p-6 hover:!transform-none">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    {["Professional", "Casual", "Funny", "Motivational", "Educational"].map((tone) => (
                                        <button
                                            key={tone}
